...
export default function Checkout() {
  ...
  const [savedAddresses, setSavedAddresses] =
    useState<Record<string, SavedAddress>>({});
  ...
  useEffect(() => {
    const loadAddresses = async () => {
      ...
      try {
        ...
        if (firstAddress) {
          setAddressType(firstAddress.type);
  ...
  const handleSubmit = (
    ...
    setTimeout(() => {
      try {
        /*
         * IMPORTANT:
         * createOrder() updates AppContext.orders
         * and clears the cart.
         */
        ...
        <div className="text-center max-w-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8">
            <button
              ...
              className="bg-charcoal text-white px-8 py-3 rounded-xl hover:bg-gold hover:text-charcoal transition"
            >
              View Orders
            </button>
            ...
            <button
              ...
              className="border border-charcoal px-8 py-3 rounded-xl hover:bg-charcoal hover:text-white transition"
            >
              Continue Shopping
            </button>
          </div>
